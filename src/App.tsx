...
function Header() {
  return <header><div className="nav shell"><Brand /><nav><a href="/#why">Why it exists</a><a href="/#features">Features</a><a href="/#demo">Demo</a><a href="/#commitment">Commitment</a><a className="nav-cta" href="/app-install">Get the app</a></nav></div></header>
}
